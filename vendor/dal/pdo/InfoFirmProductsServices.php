...
class InfoFirmProductsServices extends \DAL\DalSlim {
    ...
    public function getAll($params = array()) {
        try {
			...
			a.confirm_id,
                    ...
                    LEFT JOIN info_firm_products_services ifpx ON (ifpx.id = a.id OR ifpx.language_parent_id=a.id) AND ifpx.active = 0 AND ifpx.deleted = 0 AND ifpx.language_id =lx.id  
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (\Utill\Dal\Helper::haveRecord($getFirm)) {
                    ...
                    if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                        ...
                        $ConsultantId = 1001;
                        $getConsultant = SysOsbConsultants::getConsultantIdForTableName(array('table_name' => 'info_firm_products_services' , 'operation_type_id' => $operationIdValue));
    ...
    /**       
     * @author Okan CIRAN
     * @ info_firm_products_services tablosuna aktif olan diller için ,tek bir kaydın tabloda olmayan diğer dillerdeki kayıtlarını oluşturur   !!
     * @version v 1.0  20.06.2016
     * @return array
     * @throws \PDOException
     */
        ...
        try {
			...
			auth_allow_id,  
				...
				c.auth_allow_id,  
                            ...
                            FROM info_firm_products_services c
                    ...
                    WHERE xy.language_main_code NOT IN 
                        (SELECT 
                         ...
                         FROM info_firm_products_services cx 
     ...
     * 
     * @author Okan CIRAN
     * @ text alanları doldurmak için info_firm_products_services tablosundan tek kayıt döndürür !! 
        ...
        try {
			...
			concat(COALESCE(NULLIF(sgcx.description, ''), sgc.description_eng)) AS gtip,
		        ...
		        COALESCE(NULLIF(lx.language, ''), 'en') AS language_name,
                    ...
                    INNER JOIN sys_language l ON l.id = a.language_id AND l.deleted =0 AND l.active =0
                    LEFT JOIN sys_language lx ON lx.id = " . intval($languageIdValue) . " AND lx.deleted =0 AND lx.active =0
                    LEFT JOIN info_firm_products_services ifpx ON (ifpx.id = a.id OR ifpx.language_parent_id=a.id) AND ifpx.cons_allow_id = 2 AND ifpx.language_id =lx.id                      
