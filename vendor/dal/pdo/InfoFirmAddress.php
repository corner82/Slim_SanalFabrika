...
class InfoFirmAddress extends \DAL\DalSlim {
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için info_firm_address tablosundan user in firmasının kayıtlarını döndürür !!
     * @version v 1.0  09.02.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
     ...
     * user interface datagrid fill operation get row count for widget
     * @author Okan CIRAN
     * @ Gridi doldurmak için info_firm_address tablosundan user in firmasının çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  16.05.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
