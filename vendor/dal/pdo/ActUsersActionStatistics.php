        ...
        try {
            ...
            if ($getFirmId != NULL OR $getUserId != NULL) {
               ...
               VALUES (
                ...
                //    $statement->bindValue(':sys_acl_restservice_id', $sysAclRestserviceIdValue, \PDO::PARAM_INT);
                //    $statement->bindValue(':language_id', $languageIdValue, \PDO::PARAM_INT);
                //   $statement->bindValue(':firm_id', $getFirmId, \PDO::PARAM_INT);
                //    $statement->bindValue(':user_id', $getUserId, \PDO::PARAM_INT);
